                ...
                <div class="main-content clearfix">
                    <div class="nav-left">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="galleri-epoxy-gulve-vaegge.php">Epoxy gulve/vægge</a></li>
                    ...
                    <div class="w_content2 clearfix"> 
                        <ul class="breakcum">
                            ...
                            <li><a href="#">Epoxy gulve/vaegge</a></li>
                        </ul>
                        <h2 class="title_art">EPOXY GULVE/VÆGGE <a href="galleri.php" class="link_back">Tilbage</a></h2> 
