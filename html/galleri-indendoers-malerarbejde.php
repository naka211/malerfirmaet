                ...
                <div class="main-content clearfix">
                    <div class="nav-left">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="galleri-indendoers-malerarbejde.php">Indendørs malerarbejde</a></li>
                            <li><a href="galleri-udendoers-malerarbejde.php">Udendørs malerarbejde</a></li>
                            <li><a href="galleri-moenstret-tapet-fototapet.php">Mønstret tapet/fototapet</a></li>
                        </ul>
                    </div>
                    <div class="w_content2 clearfix"> 
                        <ul class="breakcum">
                            ...
                            <li><a href="#">Indendørs malerarbejde</a></li>
                        </ul>
                        <h2 class="title_art">INDENDØRS MALERARBEJDE<a href="galleri.php" class="link_back">Tilbage</a></h2> 
