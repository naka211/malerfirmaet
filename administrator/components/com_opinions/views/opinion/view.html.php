 ...
 * View to edit
 */
class OpinionsViewOpinion extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        $canDo = OpinionsHelper::getActions();
        ...
        if (!$isNew && $canDo->get('core.create')) {
            JToolBarHelper::custom('opinion.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
        }
        if (empty($this->item->id)) {
            JToolBarHelper::cancel('opinion.cancel', 'JTOOLBAR_CANCEL');
        } else {
            JToolBarHelper::cancel('opinion.cancel', 'JTOOLBAR_CLOSE');
        }
    }
